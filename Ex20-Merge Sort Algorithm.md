...
Start the program. Define a method mergeSort() that divides the array into two halves recursively until single elements remain. Define a method merge() that merges two sorted halves into a single sorted array. In the main() method: Initialize an array of integers. Display the original (unsorted) array. Call the mergeSort() method to sort the array. Display the sorted array. Stop the program.
## Program:
```
/*
...
## Output:
<img width="687" height="218" alt="image" src="https://github.com/user-attachments/assets/a7ebda5b-0ba7-4164-9ac8-d3ab1a452a14" />
