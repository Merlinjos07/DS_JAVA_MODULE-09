...
## Algorithm
Start the program. Create a Queue using the LinkedList class. Enqueue (add) customers to the queue as they arrive. Display the current queue of customers. Dequeue (remove) customers from the queue one by one as they are served. Display which customer is being served and the remaining queue. Repeat until all customers are served.
## Program:
```
/*
...
## Output:
<img width="842" height="543" alt="image" src="https://github.com/user-attachments/assets/cd56870c-c3bd-469a-95d3-aea56e3ece16" />
